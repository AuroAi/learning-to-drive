...
public class ReachTargetAgent_1 : Agent
{
    ...
    public override void CollectObservations(VectorSensor sensor)
    {
        ...
        sensor.AddObservation(gameObject.transform.position); // vec 3

        // Agent velocity
        sensor.AddObservation(m_rbody.velocity); // vec 3

        // Compute the direction to the target and the alignment of the agent's velocity
